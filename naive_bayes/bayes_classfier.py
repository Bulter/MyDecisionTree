...
#         return res
#
#     # def get_label(self, y_r_acc_1, x_acc_1, z_acc_2, x_std_3, z_std_2, xavr_acc_2, zavr_acc_3, z1_acc_3, z2_acc_2,
#     #               x_m_acc_2, delta_std_1, del_amp_amp_3, sp1_speed_1, sp2_speed_1, dur_2):
#     #     '''获取某一组特征值的类别'''
#     #     self._attrs = [y_r_acc_1, x_acc_1, z_acc_2, x_std_3, z_std_2, xavr_acc_2, zavr_acc_3, z1_acc_3, z2_acc_2,
#     #                    x_m_acc_2, delta_std_1, del_amp_amp_3, sp1_speed_1, sp2_speed_1, dur_2]
#     #     #        print(self._attrs)
#     #     prob_b = 0
#     #     res = {}
...
#     #         prob = self._priori_prob[label]  # 取某水果占比率
#     #         for attr in self._attrs:
#     #             if self._likelihold_prob[label][attr] == 0:
#     #                 self._likelihold_prob[label][attr] = 1 / len(self._data)
#     #                 print(" ---条件概率为零，重置为", self._likelihold_prob[label][attr])
